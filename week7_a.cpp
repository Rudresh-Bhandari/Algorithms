...
class Graph{
    ...
    void dijsktraSSSP(T src){
        ...
        // Make a set to find the minimum distance 
        // in (set) sorting is always done according to the first parameter 
         set<pair<int,T>>s;
         dist[src]=0;
        ...
        //  Lets print distacnce to all other nodes form src
        for(auto d:dist){
